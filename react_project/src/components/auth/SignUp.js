       ...
       <div className="container">
         <form onSubmit={this.handleSubmit} className="white">
           ...
           <div className="input-field">
             ...
             <span className="helper-text" data-error="please enter your correct phone number" data-success="right"> </span>
           </div>
           <div className="input-field">
             <label htmlFor="email">Email</label>
             <input type="email" id="email" className="validate" required aria-required="true"  onChange={this.handleChange} />
             <span className="helper-text" data-error="invalid email" data-success="right"> </span>
           </div>
           <div className="input-field">
             <label htmlFor="password">Password</label>
             <input type="password" className="validate" id="password" required pattern='^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{6,}$' aria-required="true" onChange={this.handleChange}/>
             <span className="helper-text" data-error="your password should include words and numbers" data-success="right"> </span>
           </div>
           <div className="input-field">
