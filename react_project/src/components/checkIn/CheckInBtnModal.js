...
class CheckInBtnModal extends Component {
  ...
  render() {
    ...
    const user = (auth) ? ( 
      <React.Fragment>
        ...
        <React.Fragment>
          <span><b>First Name:</b></span>
          <input type='text' id='firstName'  className="validate" required pattern='/[^\s]/' aria-required="true" placeholder='firstName' onChange={this.handleChange} />
          <div>
            <span><b>Last Name:</b></span>
            <input type='text' id='lastName' placeholder='lastName'className="validate" required pattern='/[^\s]/' aria-required="true" onChange={this.handleChange} />
          </div>
          <div>
            <span><b>Phone:</b></span>
            <input type='text' id='phone' placeholder='phone'  name="phone"  className="validate" required pattern='^((8|\+7)[\- ]?)?(\(?\d{3}\)?[\- ]?)?[\d\- ]{7,10}$' aria-required="true" onChange={this.handleChange} />
          </div>
          <span><b>Email:</b></span>
          <input type='email' id='email' placeholder='email'  className="validate" required aria-required="true" onChange={this.handleChange} />
  ...
  <div className=" btn-floating btn-large modal-trigger waves-effect waves-light red " data-target="modal1"><i className="material-icons">create</i></div>
          <div ref={Modal => { this.Modal = Modal; }} id="modal1" className="modal modal-fixed-footer">
            <div className="modal-content">
              ...
              <div>
            <span><b>Date:</b></span>
            <input type="date" min="2019-11-25" max="2020-02-30" id='date' placeholder='date'  className="validate" required aria-required="true" onChange={this.handleChange} />
          </div>
          <div>
            <span><b>Time:</b></span>
            <input type="time" id='time' placeholder='time'  className="validate" required aria-required="true" onChange={this.handleChange} />
          </div>
            </div>
            <div className="modal-footer">

              <input type="submit" className="modal-close blue btn-flat" value="Submit" />
              <div className="modal-close    red btn-flat" >Cancel</div>
            </div>
          </div>
        </form>
        </React.Fragment>
